...
function crearPDF(factura, paciente) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const Factura = new pdfmake_1.default(fonts);
        ...
        const contenido = [
            ...
            { text: 'DATOS DEL CLIENTE', style: 'header', margin: [0, 0, 0, 15] },
            {
                table: {
                    ...
                    body: [
                        [
                            { text: `Nombre: ${(0, encriptado_1.decryptData)(paciente.nombre)}`, style: 'tableCell', lineHeight: 1.2 },
                            { text: `Dirección: ${(0, encriptado_1.decryptData)(paciente.direccion_domicilio)}`, style: 'tableCell', lineHeight: 1.2 }
                        ],
                        [
                            { text: `ID: ${paciente.numero_documento}`, style: 'tableCell', lineHeight: 1.2 },
                            { text: `Teléfono: ${(0, encriptado_1.decryptData)(paciente.telefono)}`, style: 'tableCell', lineHeight: 1.2 }
                        ],
                        [
                            { text: `Correo: ${(0, encriptado_1.decryptData)(paciente.email)}`, style: 'tableCell', lineHeight: 1.2 },
                            { text: `Ciudad: ${(0, encriptado_1.decryptData)(paciente.ciudad_domicilio)}`, style: 'tableCell', lineHeight: 1.2 }
                        ]
                    ]
                },
        ...
        const pdfDoc = Factura.createPdfKitDocument(docDefinition);
